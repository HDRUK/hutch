...
{
  public override ComputationalWorkflow? Read(ref Utf8JsonReader reader, Type typeToConvert,
    JsonSerializerOptions options)
  {
    ...
    var computationalWorkflow = new ComputationalWorkflow(identifier: Id, properties: properties);
