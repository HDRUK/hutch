...
public class RootDatasetConverter : EntityConverter
{
  public override RootDataset? Read(ref Utf8JsonReader reader, Type typeToConvert,
    JsonSerializerOptions options)
  {
    ...
    var rootDataset = new RootDataset(identifier: Id, properties: properties);
    return rootDataset;
  }
}
