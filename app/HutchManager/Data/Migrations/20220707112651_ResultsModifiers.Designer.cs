...
namespace HutchManager.Migrations
{
    ...
    [Migration("20220707112651_ResultsModifiers")]
    partial class ResultsModifiers
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HutchManager.Models.ActivitySourceModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("ActivitySourceModel");
                });

            modelBuilder.Entity("HutchManager.Models.ModifierTypeModel", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("HutchManager.Data.Entities.ResultsModifier", b =>
                {
                    b.HasOne("HutchManager.Models.ActivitySourceModel", "ActivitySource")
                        .WithMany()
                        .HasForeignKey("ActivitySourceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HutchManager.Models.ModifierTypeModel", "Type")
                        .WithMany()
                        .HasForeignKey("TypeId");
