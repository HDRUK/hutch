...
public class WfexsStageFile
{
  ...
  [YamlMember(Alias = "cacheDir")] public string CacheDirectory { get; set; } = string.Empty;

  [YamlMember(Alias = "crypt4gh")] public Crypt4ghOptions Crypt4Gh { get; set; } = new();

  [YamlMember(Alias = "outputs")] public Dictionary<string, Dictionary<string, string>> Outputs = new();
